...
class M_receivable_repayment extends Model
{
    ...
    {
        $builder = $this->db->table('hd_sales_admin')->select("sales_admin_invoice, sales_date, sales_due_date, sales_admin_grand_total, sales_admin_down_payment, sales_admin_remaining_payment, customer_name, store_name, store_code");
