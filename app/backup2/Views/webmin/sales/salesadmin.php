                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header p-2">
                            ...
                            <form method="post" id="import_form_excell" enctype="multipart/form-data">
                                <input name="excell" type="file" />
                                    <button type="submit" id="btnexcellimport" class="btn btn-success"><i class="fas fa-file-excel"></i> Excell</button>
                            </form>
...
$('#import_form_excell').on('submit', function(event){
