    ...
    <div class="ticket">
        ...
        <table id="info">
            <tbody>
                <tr>
                    ...
                    <td>:</td>
                    <td class="col-2">SR/UTM/22/09/00001</td>
                    <td class="col-3 text-right"></td>
                </tr>
                <tr>
                    <td class="col-1">TGL</td>
                    <td>:</td>
                    <td class="col-2"><?= indo_short_date('2022-08-26 22:00:00', false) ?></td>
                    <td class="col-3 text-right"></td>
                </tr>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <td class="qty text-right">2.00</td>
                    <td class="exp-symbol">x</td>
                    <td class="price">3,500.00</td>
                    <td class="total text-right">7,000.00</td>
                </tr>
                <tr>
                    <td class="description border-top" colspan="4">Indomie Goreng (BKS)</td>
                </tr>
                <tr>
                    <td class="qty text-right">1.00</td>
                    <td class="exp-symbol">x</td>
                    <td class="price">3,300.00</td>
                    <td class="total text-right">3,300.00</td>
                </tr>


                <tr>
                    <td class="sub-description text-right border-top border-bottom" colspan="3">Total Retur</td>
                    <td class="total text-right border-top border-bottom">10,300.00</td>
                </tr>
