...
<script>
    $(document).ready(function() {
        ...
        $.fn.editable.defaults.url = base_url + '/webmin/user/user-group/setgrouprole';
        ...
        let tblusergroup = $("#tblusergroup").DataTable({
            ...
            ajax: {
                url: base_url + '/webmin/user/user-group/table',
                type: "POST",
                error: function() {
        ...
        function checkGroupName(group_name) {
            let actUrl = base_url + '/webmin/user/user-group/getbyname';
            useLoader = false;
        ...
        $('#btnsave').click(function(e) {
            ...
            if (form.parsley().isValid()) {
                ...
                let actUrl = base_url + '/webmin/user/user-group/save/add';
                if (formMode == 'edit') {
                    question = 'Yakin ingin memperbarui data grup?';
                    actUrl = base_url + '/webmin/user/user-group/save/edit';
                }
        ...
        $("#tblusergroup").on('click', '.btnedit', function(e) {
            ...
            let actUrl = base_url + '/webmin/user/user-group/getbycode/' + id;
        ...
        $("#tblusergroup").on('click', '.btndelete', function(e) {
            ...
            let actUrl = base_url + '/webmin/user/user-group/delete/' + id;
            message.question(question).then(function(answer) {
                let yes = parseMessageResult(answer);
                if (yes) {
                    ajax_get(actUrl, null, {
        ...
        $("#tblusergroup").on('click', '.btnsetup', function(e) {
            e.preventDefault();
            let id = $(this).attr('data-id');
            let actUrl = base_url + '/webmin/user/user-group/getgrouprole/' + id;
            ajax_get(actUrl, null, {
                success: function(response) {
                    if (response.success) {
                        if (response.result.exist) {
