            ...
            <div class="row">
                ...
                <div class="col-md-12 ">
                    <div class="card">
                        <div class="card-body">
                            <h5>Preview</h5>
                            <iframe id="preview" src="<?= base_url('webmin/report/cart-debt-list') ?>" width="100%" height="1000px"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.col -->
...
<script>
    $(document).ready(function() {
        ...
        $('#btnsearch').click(function(e) {
            ...
            let reportUrl = '<?= base_url('webmin/report/cart-debt-list') ?>?';
