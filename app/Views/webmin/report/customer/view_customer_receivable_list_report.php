...
<div>
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Daftar Penerimaan Piutang</h1>
                </div>
                ...
                <div class="col-md-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <iframe id="preview" src="<?= base_url('webmin/report/customer-receivable-list-report') ?>" width="100%" height="1000px"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.col -->
...
<script>
    ...
    $('#btnsearch').click(function(e) {
        ...
        let reportUrl = '<?= base_url('webmin/report/customer-receivable-list-report') ?>?';
