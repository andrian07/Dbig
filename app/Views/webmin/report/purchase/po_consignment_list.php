...
<?php
foreach ($pages as $POConsignmentData) :
    ?>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="3" align="center">
                                <p class="header2">DAFTAR PO KONSINYASI</p>
                                <br>
                            </td>
                        </tr>
                        <tr valign="top">
                                ...
                                <table>
                                    <tbody>
                                        <tr align="left" class="loseborder">
                                            ...
                                            <td width="160" class="loseborder">: Konsinyasi</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                    ...
                    <table width="100%" celpadding="0" cellspacing="0" class="table-bordered table-detail">
                        <thead>
                            <tr>
                                ...
                                <th class="header-table" width="10%">MEREK</th>
                                <th class="header-table" width="10%">SUPPLIER</th>
                                <th class="header-table" width="10%">STATUS</th>
                        ...
                        <tbody>
                            ...
                            foreach ($POConsignmentData as $row) :
                                $dt_po_consignment_qty = floatval($row['dt_po_consignment_qty']);
                                ?>
                                <tr align="left">
                                    <td class="text-left"><?= $last_po_consignment_invoice == $row['purchase_order_consignment_invoice'] ? '' : $row['purchase_order_consignment_invoice'] ?>&nbsp;</td>
                                    <td class="text-left"><?= indo_short_date($row['purchase_order_consignment_date'], FALSE) ?>&nbsp;</td>
                                    ...
                                    <td class="text-left"><?= $row['purchase_order_consignment_status'] ?>&nbsp;</td>
                                    <td class="text-left"><?= $dt_po_consignment_qty ?> <?= $row['unit_name'] ?>&nbsp;</td>
                                </tr>
                                <?php
