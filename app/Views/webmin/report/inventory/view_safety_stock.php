            ...
            <div class="row">
                ...
                <div class="col-md-12 ">
                    <div class="card">
                        <div class="card-body">
                            <h5>Preview</h5>
                            <iframe id="preview" src="<?= base_url('webmin/report/safety-stock') ?>" width="100%" height="1000px"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.col -->
...
<script>
    $(document).ready(function() {
        function reportUrl(params = '') {
            ...
            let reportUrl = base_url + '/webmin/report/safety-stock?';
