...
<div>
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Daftar Retur Penjualan Proyek</h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 ">
                    <div class="card">
                        <div class="card-body">
                            <h5>Preview</h5>
                            <iframe id="preview" src="<?= base_url('webmin/report/retur-project-sales-list') ?>" width="100%" height="1000px"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.col -->
...
<script>
    $(document).ready(function() {
        ...
        $('#btnsearch').click(function(e) {
            ...
            let reportUrl = '<?= base_url('webmin/report/retur-project-sales-list') ?>?';
