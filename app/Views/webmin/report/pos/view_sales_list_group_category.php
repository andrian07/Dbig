            ...
            <div class="row">
                ...
                <div class="col-md-12 ">
                    <div class="card">
                        <div class="card-body">
                            <h5>Preview</h5>
                            <iframe id="preview" src="<?= base_url('webmin/report/detail-sales-list-group-category') ?>" width="100%" height="1000px"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.col -->
...
<script>
    $(document).ready(function() {
        function reportUrl(params = '') {
            let selCategory = $('#category_id').select2('data');
            ...
            let category_name = '';
            if (selCategory[0]) {
                category_name = selCategory[0].text;
            }
            ...
            let reportUrl = base_url + '/webmin/report/detail-sales-list-group-category?';

            reportUrl += 'start_date=' + $('#start_date').val();
            reportUrl += '&end_date=' + $('#end_date').val();
            reportUrl += '&category_id=' + category_id;
            reportUrl += '&category_name=' + category_name;
