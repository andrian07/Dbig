...
<body>
	<div class="invoice-a4">
		...
		<div class="content-invoice">
			<h3 class="text-center">RETUR PENJUALAN</h3>
			<table class="info-date">
				<tr>
					<td>Date</td><td>:</td><td><?= indo_date($hdRetur['hd_retur_date']) ?></td>
				</tr>
				<tr>
					<td>No Retur</td><td>:</td><td><?= esc($hdRetur['hd_retur_sales_admin_invoice']) ?></td>
				</tr>
			</table>
			...
			<div class="address-content">
				<div class="left address-content-left">
					...
					<h4 style="margin-top: -19px;"><?= esc($hdRetur['customer_name']) ?></h4>
					<P style="width: 80%;"><?= esc($hdRetur['customer_address']) ?></P>
				</div>
