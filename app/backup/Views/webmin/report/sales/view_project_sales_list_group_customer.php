...
<div>
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Daftar Penjualan Proyek Per Customer</h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 ">
                    <div class="card">
                        <div class="card-body">
                            <h5>Preview</h5>
                            <iframe id="preview" src="<?= base_url('webmin/report/project-sales-list-group-customer') ?>" width="100%" height="1000px"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.col -->
...
<script>
    $(document).ready(function() {
        ...
        $('#btnsearch').click(function(e) {
            ...
            let url = base_url + '/webmin/report/project-sales-list-group-customer';
            if (detail) {
                url = base_url + '/webmin/report/project-sales-list-group-customer?detail=Y';
            }
