                ...
                <table width="100%" celpadding="0" cellspacing="0" class="table-bordered table-detail">
                    <thead>
                        <tr>
                            ...
                            <th class="header-table" width="10%" nowrap="">NO TRANSFER</th>
                            <th class="header-table" width="20%">DARI GUDANG</th>
                            <th class="header-table" width="20%">KE GUDANG</th>
                            <th class="header-table" width="20%">TOTAL STOK</th>
                            <th class="header-table" width="20%">USER</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr align="left">
                            <td class="text-left">01/09/2022&nbsp;</td>
                            <td align="text-left" nowrap="">ST/UTM/22/09/000001&nbsp;</td>
                            <td class="text-left col-fixed">UTM - PUSAT&nbsp;</td>
                            <td class="text-left col-fixed">KBR - CABANG KOTA BARU</td>
                            <td class="text-right">50.00</td>
                            <td class="col-fixed text-left">Reza</td>
                        </tr>

                        <tr align="left">
                            <td class="text-left">01/09/2022&nbsp;</td>
                            <td align="text-left" nowrap="">ST/UTM/22/09/000002&nbsp;</td>
                            <td class="text-left col-fixed">KNY - KONSINYASI&nbsp;</td>
                            <td class="text-left col-fixed">UTM - PUSAT</td>
